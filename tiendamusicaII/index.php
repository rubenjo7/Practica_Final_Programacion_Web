                ...
                <section id = "menucentral">
                  ...
                  <section id = "parteizq"> 
                   ...
                   <article id = "izquierda">
                    ...
                    <p>Disco más vendido:</p>

                    <article class = "pop">
                      <table class="tabla" >
                        <tr>
                          <td width="30%" rowspan="3"><img src="Discos/disco2.jpg" alt="estopa" width="140px" height = "140px" /></a> </td>
                    ...
                    <section id = "margencentral2"><br></section>

                    <article id = "derecha">
                      <p>Discos más vendidos:</p>
                      ...
                      <table class="tabla2" >
                        <tr>
                          ...
                          <td width = "20%"><img src="Discos/disco2.jpg" alt="estopa" width="60px" height = "60px" /></a></td>
                          <td id = "tit">Rumba a lo desconocido.</td>
                        </tr>
                      </table>
